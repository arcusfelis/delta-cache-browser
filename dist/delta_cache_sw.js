...
/***/ (function(module, exports, __webpack_require__) {
	...
	const fetchUtil = __webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const fetchUtil = __webpack_require__(8);
	const vcdiff = __webpack_require__(9);
	const xxhash = __webpack_require__(19);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const VCDiff = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const errors = __webpack_require__(10);
	const TypedArray = __webpack_require__(12);
	const deserializeInteger = __webpack_require__(13);
	const deserializeDelta = __webpack_require__(14);
	const NearCache = __webpack_require__(17);
	const SameCache = __webpack_require__(18);
...
/***/ (function(module, exports) {
	...
	TypedArrayList.prototype.get = function(index) {
	  ...
	  // special case is source array of size 0
	  if (this.typedArrays[listIndex].length == 0)
	      listIndex++;
	...
	TypedArrayList.prototype.set = function(index, value) {
	  ...
	  // it's a hack
	  if (typedArrayIndex < this.typedArrays[listIndex].length)
	  {
	  }
	  else
	  {
	//    console.log("allocate more");
	      let tmp = new Uint8Array(typedArrayIndex + 1);
	      let len = this.typedArrays[listIndex].length;
	      for (var i = 0; i < len; i++)
	          tmp[i] = this.typedArrays[listIndex][i];

	      this.typedArrays[listIndex] = tmp;
	      this.typedArrays[listIndex][typedArrayIndex] = value;
	      console.dir(this.typedArrays[listIndex][typedArrayIndex]);
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const errors = __webpack_require__(10);
	const deserializeInteger = __webpack_require__(13);
	const tokenizeInstructions = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const instructions = __webpack_require__(16);
	const deserializeInteger = __webpack_require__(13);
	...
	function tokenizeInstructions(instructionsBuffer) {
	  ...
	  while (instructionsPosition < instructionsBuffer.length) {
	    ...
	    // use index to match the instruction later
	    /*
	    console.log('tokenizeInstructions '
	           + 'instruction_number=' + deserializedInstructions.length + ' '
	           + 'index=' + index);
	           */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function ADD(size) {
	  if (isNaN(size))
	      throw new Error("Not a number " + size);
	  this.size = size;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		h32: __webpack_require__(20)
	,	h64: __webpack_require__(24)
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	MIT license
	*/
	var UINT32 = __webpack_require__(21).UINT32
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.UINT32 = __webpack_require__(22)
	exports.UINT64 = __webpack_require__(23)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	MIT license
	*/
	var UINT64 = __webpack_require__(21).UINT64
